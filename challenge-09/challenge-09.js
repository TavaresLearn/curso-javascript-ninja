(function () {
  ...
  */
  ...
  console.log( 'O resultado da soma é: '+sum(function(_num1, _num2) {
    return _num1 + _num2;
  }));
  ...
  */
  ...
  var multiplication = calculator(30,40);
  var division = calculator(40,50);
  var mod = calculator(100,60);
  ...
  chamada.
  */
  console.log( 'O resultado da subtração é:'+subtraction(function(_num1, _num2) {
    return _num1 - _num2;
  }));


  console.log( 'O resultado da multiplicação é:'+multiplication(function(_num1, _num2) {
    return _num1 * _num2;
  }));

  console.log( 'O resultado da divisão é:' +division(function(_num1, _num2) {
    return _num1 / _num2;
  }));

  console.log( 'O resto da divisão é:' +mod(function(_num1, _num2) {
    return _num1 % _num2;
  }));
