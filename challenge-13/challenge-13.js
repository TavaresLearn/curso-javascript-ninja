(function () { /*
  ...
  */
  var sul = ['Paraná', 'Sta Catarina', 'Rio Grande do Sul'];
  ...
  */
  ...
  console.log(brasil.unshift('Acre','Amazonas', 'Amapá'),brasil);
  ...
  */
  var newSul = brasil.slice( 2,5 ); // pega itens de indice 2 até 4 (5 não inclui)
  ...
  */
  ...
  chamada `newSudeste`.
  */
  //var newSudeste = brasil.splice( 5,4 ); //a partir do indice 5 remove 4 itens
  var newSudeste = brasil.splice( 5 ); //versao melhorada pois todos os itens a partir do indice 5 são do sudeste
